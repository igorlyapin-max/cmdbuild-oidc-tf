...
2. `cmdbuild-integration`: add a CMDBuild OIDC verification checklist separating browser authentication, immutable `sub` local-user mapping, REST bearer validation, per-user grants, wrong-audience rejection, and fail-closed unknown-user behavior.
